...
function formStateProvider(Form) {
    return _a = /** @class */ (function (_super) {
            ...
            FormStateProvider.prototype.submit = function (event) {
                ...
                handlerEngine_1.invokeHandler('form', function () { return _this.props.submitter(immutable_1.Map(_this.state.values).toJS(), _this.hasError(), _this.isPristine()); }, function () {
