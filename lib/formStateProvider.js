...
var eventHandlerAdaptors_1 = require("./eventHandlerAdaptors");
    ...
    return _a = /** @class */ (function (_super) {
            ...
            FormStateProvider.prototype.render = function () {
                ...
                var props = immutable_1.Map(this.props)
                    ...
                    // FormPropsEx
                    formOnChange: eventHandlerAdaptors_1.changeAdaptor(this.change),
                    formOnValidate: eventHandlerAdaptors_1.focusAdaptor(this.validate),
                }).toJS();
