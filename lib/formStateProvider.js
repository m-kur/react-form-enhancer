...
function formStateProvider(Form) {
    return _a = /** @class */ (function (_super) {
            ...
            FormStateProvider.prototype.invokeValidator = function (name, newValue) {
                ...
                var currentValues = immutable_1.Map(this.state.values).set(name, newValue).toJS();
                handlerEngine_1.invokeHandler(name, function () { return validator(currentValues, name, _this.notify); }, function () { return _this.updateErrors(name, null); }, function (reason) { return _this.updateErrors(name, reason); }, this.notify);
            };
            ...
            FormStateProvider.prototype.submit = function (event) {
                ...
                handlerEngine_1.invokeHandler('form', function () {
                    ...
                    return _this.props.submitter(values, 'form', _this.notify);
                }, function () {
            ...
            FormStateProvider.prototype.render = function () {
                ...
                var props = immutable_1.Map(this.props)
                    ...
                    // FormPropsEx
                    formOnChange: eventAdaptors_1.changeAdaptor(this.change),
                    formOnValidate: eventAdaptors_1.focusAdaptor(this.validate),
                }).toJS();
